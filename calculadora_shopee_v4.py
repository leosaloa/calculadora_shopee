...
Total: R$ {tx_com_total_6:.2f}
            \nLucro líquido: R$ {lucro_com_frete:.2f}''', width = 300, height = 250, bg_color = '#4F4F4F')
...
Total: R$ {tx_sem_total_6:.2f}
            ...
            \nLucro líquido R$ {lucro_sem_frete:.2f}''', width = 300, height = 250, bg_color = '#4F4F4F')
